...
# ## NOTE: mc hack - the only line that needed a change:
var _rokoko_reader : SCRokokoReader = SCRokokoReader.new()
...
func _init(
	...
	print("SCRokokoSource -- %s added body tracker: %s" % [XRServer, body_tracker_name])
